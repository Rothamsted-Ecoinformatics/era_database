create table lte_data.experiment_factor_levels (
	...
	factor_level_term_id int2 null, -- not everything will have an annotation but can be used to provide extra granularity
...
comment on column lte_data.experiment_factor_levels.factor_level_term_id is 'This is an optional FK to an ontology annotation for the factor level';
...
comment on column lte_data.experiment_factor_levels.factor_level_label is 'This is a decriptive label for the experiment factor level and should use full English words. It can be used as an alternative to the default factor_level_term.';
