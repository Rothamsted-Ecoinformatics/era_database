create table lte_data.experiment_factors (
	...
	constraint experiment_factors_experiment_id_fk foreign key (experiment_id) references lte_data.experiments(id),
	constraint experiment_factors_factor_term_id_fk foreign key (factor_term_id) references lte_data.factor_terms(id)
);
