create table lte_data.dataset_awards (
	...
	constraint dataset_award_dataset_id_fk foreign key (dataset_id) references lte_data.datasets(id),
	constraint dataset_award_award_id_fk foreign key (award_id) references lte_data.awards(id),
