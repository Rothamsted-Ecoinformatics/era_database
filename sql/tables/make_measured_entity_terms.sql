create table lte_data.measured_entity_terms (
	...
	constraint measured_entity_terms_ontology_id_fk foreign key (ontology_id) references lte_data.ontologies(id),
	constraint measured_entity_terms_preferred_term_id foreign key (preferred_term_id) references lte_data.measured_entity_terms(id),
