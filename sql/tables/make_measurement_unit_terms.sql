create table lte_data.measurement_unit_terms (
	...
	constraint measurement_unit_terms_ontology_id foreign key (ontology_id) references lte_data.ontologies(id),
	constraint measurement_unit_terms_preferred_term_id foreign key (preferred_term_id) references lte_data.measurement_unit_terms(id),
