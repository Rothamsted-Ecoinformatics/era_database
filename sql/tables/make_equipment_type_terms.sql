create table lte_data.equipment_type_terms (
	...
	constraint equipment_type_termd_ontology_id foreign key (ontology_id) references lte_data.ontologies(id),
	constraint equipment_type_terms_preferred_term_id foreign key (preferred_term_id) references lte_data.equipment_type_terms(id),
