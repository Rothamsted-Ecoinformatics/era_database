create table lte_data.input_form_terms (
	...
	constraint input_form_terms_ontology_id foreign key (ontology_id) references lte_data.ontologies(id),
	constraint input_form_terms_preferred_term_id foreign key (preferred_term_id) references lte_data.input_form_terms(id),
	constraint input_form_terms_term_uri_unq unique (term_uri)
);

comment on table lte_data.input_form_terms is 'input_form_terms dimension table used to provide a standardised classification for 
