create table lte_data.harvesting_activity_logs (
	...
	constraint harvesting_activity_logs_plot_year_id_fk foreign key (plot_year_id) references lte_data.plot_years(id),
	constraint harvesting_activity_logs_activity_log_type_term_id foreign key (activity_log_type_term_id) references lte_data.activity_log_type_terms(id),
	constraint harvesting_activity_logs_equipment_id foreign key (equipment_id) references lte_data.equipment(id)
);
