...
comment on table lte_data.product_role_terms is 'product_role_terms dimension table used to provide a standardised classification for product roles backed by a curated ontology term, if one exists.';
